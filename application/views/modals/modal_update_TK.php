<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Update Pertanyaan <br> Bagian II : Tata Kelola Sistem Informasi </h3>

  <form id="form-update-TK" method="POST">
    <input type="hidden" name="id" value="<?php echo $dataTK->id; ?>">
      ...
      <span class="input-group-addon" id="sizing-addon2">
        <i class="fa fa-check-circle"></i>
                  ...
                  <select name="tingkat_kematangan" class="form-control select2" aria-describedby="sizing-addon2" style="width: 100%" required="">
                     ...
                     <?php
                      $matang=$dataTK->tingkat_kematangan;
                      if ($matang=='I') { echo'
      ...
      <span class="input-group-addon" id="sizing-addon2">
        <i class="fa fa-check-circle"></i>
                  ...
                  <select name="tingkat_kelengkapan" class="form-control select2" aria-describedby="sizing-addon2" style="width: 100%" required="">
                     ...
                     <?php
                      $lengkap=$dataTK->tingkat_kelengkapan;
                      if ($lengkap=='1') { echo'
     ...
     <div class="input-group form-group">
      <textarea class="tinymce" id="editor1" name="pertanyaan" rows="10" cols="80" placeholder="Pertanyaan . . . . . . " ><?php echo $dataTK->pertanyaan; ?></textarea>
    </div>
