<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Update Pertanyaan <br> Bagian V : Pengelolaan Aset Informasi </h3>

  <form id="form-update-PA" method="POST">
    <input type="hidden" name="id" value="<?php echo $dataPA->id; ?>">
        ...
        <i class="fa fa-check-circle"></i>
                  ...
                  <select name="kategori" class="form-control select2" aria-describedby="sizing-addon2" style="width: 100%" required="">
                     ...
                     <?php
                      $ctg=$dataPA->kategori;
                      if ($ctg=='I') { echo'
                                              <option value="I" selected>Pengelolaan Aset Informasi</option>
                                              <option value="II">Pengamanan Fisik</option>
                                        ';}

                    else if ($ctg=='II') { echo'
                                              <option value="I">Pengelolaan Aset Informasi</option>
                                              <option value="II" selected>Pengamanan Fisik</option>
                                             '; }
                      ?> 
                  </select>
                </div>
      ...
      <span class="input-group-addon" id="sizing-addon2">
        <i class="fa fa-check-circle"></i>
                  ...
                  <select name="tingkat_kematangan" class="form-control select2" aria-describedby="sizing-addon2" style="width: 100%" required="">
                     ...
                     <?php
                      $matang=$dataPA->tingkat_kematangan;
                      if ($matang=='I') { echo'
      ...
      <span class="input-group-addon" id="sizing-addon2">
        <i class="fa fa-check-circle"></i>
                  ...
                  <select name="tingkat_kelengkapan" class="form-control select2" aria-describedby="sizing-addon2" style="width: 100%" required="">
                     ...
                     <?php
                      $lengkap=$dataPA->tingkat_kelengkapan;
                      if ($lengkap=='1') { echo'
     ...
     <div class="input-group form-group">
      <textarea class="tinymce" id="editor1" name="pertanyaan" rows="10" cols="80" placeholder="Pertanyaan . . . . . . " ><?php echo $dataPA->pertanyaan; ?></textarea>
    </div>
