<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-update-kota" method="POST">
    ...
    <div class="input-group form-group">
          ...
          <select name="provinsi" class="form-control select2"  aria-describedby="sizing-addon2">
            <?php
            foreach ($dataProvinsi as $provinsi) {
              ?>
              <option value="<?php echo $provinsi->id; ?>" <?php if($provinsi->id == $dataKota->id_provinsi){echo "selected='selected'";} ?>><?php echo $provinsi->nama; ?></option>
              <?php
            }
            ?>
          </select>
