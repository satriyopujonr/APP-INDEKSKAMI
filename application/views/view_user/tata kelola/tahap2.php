...
<div class="row">
  ...
  <div class="box-body table-responsive">
       ...
       <form id="regForm" method="post" action="<?php echo base_url();?>User/TK/jawab2">
       
    
    <?php 
    $no = 1;
    foreach($dataTK2 as $row) { ?>
    ...
    <div class="tab"><h2 style="text-align: justify;"><b><?php echo $row->pertanyaan; ?></h2><br>
      ...
      <label class="container">Dalam Penerapan / Diterapkan Sebagian
        <input type="radio" name="jawaban<?=$row->id?>" value="4" oninput="this.className = ''">
        <span class="checkmark"></span>
      </label>

      <label class="container">Diterapkan Secara Menyeluruh
        <input type="radio" name="jawaban<?=$row->id?>" value="6" oninput="this.className = ''">
        <span class="checkmark"></span>
      </label>
