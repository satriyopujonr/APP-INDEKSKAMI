...
<div class="row">
  ...
  <div class="box-body table-responsive">
    ...
    <div class="tab"><h2 style="text-align: justify;"><b><?php echo $row->pertanyaan; ?></h2><br>
      ...
      <label class="container"><?=$ans_array[0]?>
        <input type="radio" name="jawaban<?=$row->id?>" value="5" oninput="this.className = ''">
        <span class="checkmark"></span>
      </label>

      <label class="container"><?=$ans_array[1]?>
        <input type="radio" name="jawaban<?=$row->id?>" value="2" oninput="this.className = ''">
        <span class="checkmark"></span>
      </label>

      <label class="container"><?=$ans_array[2]?>
